 ...
 <div class="category-admin">
            ...
            <b-row>
                <b-col  xs="12">
                    <b-form-group label="Nome:" label-for="category-name">
                        ...
                        v-model="category.name" :readonly="mode === 'remove'" required placeholder="Informe o Nome da Categoria">
                        </b-form-input>
                    </b-form-group>
                </b-col>
            </b-row>
        ...
        <b-table hover striped :items="categories" :fields="fields">
            <template slot="cell(actions)" slot-scope="data">
                <b-button variant="warning" @click="loadCategory(data.item)" class="mr-2"><i class="fa fa-pencil"></i></b-button>
                <b-button variant="danger" @click="loadCategory(data.item,'remove')"><i class="fa fa-trash"></i></b-button>
            </template>
        </b-table>
    </div>
</template>
